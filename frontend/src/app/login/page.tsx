    ...
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-[55%] bg-gradient-to-br from-purple-950 via-purple-900 to-pink-900 relative overflow-hidden items-center justify-center">
        <div className="absolute inset-0">
          <div className="absolute -top-40 -right-40 w-[500px] h-[500px] bg-pink-500/10 rounded-full blur-3xl" />
        ...
        <div className="relative text-center space-y-6 p-16 max-w-lg">
          <div className="text-8xl font-black bg-gradient-to-b from-white to-white/60 bg-clip-text text-transparent">
            Clash
          </div>
          <p className="text-2xl text-purple-200/80 font-medium">
            Discover the better choice, together
          </p>
          <div className="pt-6 text-9xl font-black text-white/5 select-none">
            VS
          </div>
        </div>
      </div>
